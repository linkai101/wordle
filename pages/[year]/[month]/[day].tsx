      ...
      <div className="w-fit relative">
        ...
        >
          <span className="flex items-center">
            {dates.length>0 &&
              <span className="block truncate text-sm md:text-md">#{wordleData.id} - {dates[dates.length-1-wordleData.id].toLocaleDateString('en-US', { weekday: 'short', month: 'long', day: 'numeric' })}</span>
            }
          </span>
